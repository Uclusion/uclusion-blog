...
Then route the three methods and serialize a response. The one gotcha worth calling out is `by_alias=True` — MCP wants camelCase (`protocolVersion`), and the SDK's Pydantic models handle that for you through aliases:
